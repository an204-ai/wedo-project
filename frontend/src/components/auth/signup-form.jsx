  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">Gia nhập với WeDO nào </h1>
              ...
              <Field>
                ...
                <Input id="name" type="text" placeholder="thanhan8912" {...register('userName')}/>
                <FieldDescription>
              ...
              <Field>
                ...
                <Input id="displayName" type="text" placeholder="Nguyễn Thành An" {...register('displayName')}/>
                <FieldDescription>
      ...
      <FieldDescription className="px-6 text-center">
        Khi tiếp tục, bạn đồng ý với <a href="#">Điều khoản sử dụng</a>{" "}
